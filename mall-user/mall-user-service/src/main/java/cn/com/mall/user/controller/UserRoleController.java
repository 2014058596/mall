...
import cn.com.mall.user.api.model.UserRoleModel;
import cn.com.mall.user.service.IUserRoleService;
...
public class UserRoleController  {
    ...
    public StandardResult selectPage(@ModelAttribute UserRoleModel userRoleModel, Integer pageSize, Integer pageNumber) {
        ...
        Wrapper<UserRoleModel> wrapper = new EntityWrapper<>(userRoleModel);
