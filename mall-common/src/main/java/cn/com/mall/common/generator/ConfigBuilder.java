package cn.com.mall.common.generator;
...
public class ConfigBuilder {
    ...
    private List<TableInfo> processTable(List<TableInfo> tableList, NamingStrategy strategy, String[] tablePrefix) {
        for (TableInfo tableInfo : tableList) {
            ...
            if (StrUtil.isNotEmpty(globalConfig.getMapperName())) {
            ...
            if (StrUtil.isNotEmpty(globalConfig.getXmlName())) {
            ...
            if (StrUtil.isNotEmpty(globalConfig.getServiceName())) {
            ...
            if (StrUtil.isNotEmpty(globalConfig.getServiceImplName())) {
            ...
            if (StrUtil.isNotEmpty(globalConfig.getControllerName())) {
    ...
    private TableInfo convertTableFields(TableInfo tableInfo, NamingStrategy strategy) {
        ...
        try {
            ...
            while (results.next()) {
                ...
                boolean isId = StrUtil.isNotEmpty(key) && StrUtil.equals("PRI", key.toUpperCase());
                // 处理ID
                if (isId && !haveId) {
    ...
    private String joinPath(String parentDir, String packageName) {
        ...
        if (!StrUtil.endWith(parentDir, File.separator)) {
